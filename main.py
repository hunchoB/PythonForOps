#TODO: необходимо произвести срез по указанным индексам (левая и правая граница, соответственно) и рассчитать показатели по полученной подвыборке. В случае, если введена пустая строка или данная конструкция - ввод останавливается и производится расчет значений
...
if __name__ == '__main__':
    rps_values = [5081, '17184', 10968, 9666, '9102', 12321, '10617', 11633, 5035, 9554, '10424', 9378, '8577', '11602', 14116, 
                  ...
                  15564, 17664, '8996', '12179', '13657', 15817, '16187', '6381', 8409, '5177', 17357, '10814', 6679, 12241, '6556', 12913, 16454, '17589', 5292, '13639', '7335', 
